...
function refreshBot() //Refreshes the AI with no information regarding the gamestate and applies rewards
{
    botReady = 0;
    actionCount++;
    console.log(brain.average_loss_window.v[brain.average_loss_window.v.length-1]);
    ...
    else if (brain.learning_steps_total === 5000000 && actionCount >= 6000000 && actionCount <= 6000005) brain.learning_steps_total = 12500000;
